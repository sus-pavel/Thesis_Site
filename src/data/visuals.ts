...
export const storyVisuals: VisualDefinition[] = [
  ...
  {
    id: 'load-profile',
    title: 'Временные ряды нагрузки по фидерам',
    dataFile: publicPath('/data/load_profiles/placeholder_load_profile.csv'),
    figureFile: publicPath('/figures/load_profiles/load_profile_fragment.svg'),
    figureAlt: 'Получасовые временные ряды активной мощности восьми фидеров за период с 1 по 17 января 2014 года',
    isReady: true,
    kind: 'line',
  },
